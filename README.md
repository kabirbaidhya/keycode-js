...
[![deno](https://img.shields.io/badge/deno-v2.0.1-green?style=flat-square)](https://deno.land/x/keycode/README.md#usagewithdeno)
...
```html
<script src="https://unpkg.com/keycode-js@2.0.1/dist/keycode.min.js"></script>
```
...
import * as KeyCode from 'https://deno.land/x/keycode@v2.0.1/mod.ts';

// Import individual constants
import { KEY_ENTER } from 'https://deno.land/x/keycode@v2.0.1/mod.ts';
